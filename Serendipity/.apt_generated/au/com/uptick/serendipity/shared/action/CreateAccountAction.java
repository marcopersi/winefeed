...
public class CreateAccountAction implements Action<CreateAccountResult> { 

  au.com.uptick.serendipity.shared.dto.sales.AccountDto accountDto;

  public CreateAccountAction(au.com.uptick.serendipity.shared.dto.sales.AccountDto accountDto) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
        return false;
    CreateAccountAction other = (CreateAccountAction) obj;
    if (accountDto == null) {
