...
public class WermuthPre2015Tests extends TestCase {
	...
	static Pattern LOT_AND_PRICE_PATTERN = Pattern.compile(".*([0-9\\'\\.]*)|(\\s-)$");
    ...
    public void testGetUnit()
    {
    	...
    	for (Entry<String, BigDecimal> aTestEntry : linesAndAssertValues.entrySet()) {
			assertEquals("tryin: " + aTestEntry.getKey(),  aTestEntry.getValue(), wermuthImportTask.determineSize(aTestEntry.getKey()));
		}    	
    }
    @Test
