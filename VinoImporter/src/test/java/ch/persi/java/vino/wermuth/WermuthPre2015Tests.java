...
class WermuthPre2015Tests {

    @Test
    void testExtractRealizedPrice() {
        ...
        for (Entry<String, Integer> aLine : someInput.entrySet()) {
            assertEquals(aLine.getValue(), WermuthPricePageParser.getRealizedPrice(aLine.getKey()));
        }
    }


    @Test
    void testSuccessfullRecordLines() {
    ...
    void testGetNumberOfBottles() {
        ...
        for (Entry<String, Integer> aLine : someInput.entrySet()) {
            ...
            assertEquals(aLine.getValue(), aNoOfBottles);
        }
    }

    @Test
    void testFailingRecordLines() {
        List<String> someRecordLines = new ArrayList<>();
    ...
    void testSizes() {
        ...
        for (Entry<String, BigDecimal> aLine : someInput.entrySet()) {
            ...
            assertEquals(aLine.getValue(), aSize);
        }
    }
    ...
    void testVintages() {
        ...
        for (Entry<String, Integer> aLine : someInput.entrySet()) {
            ...
            assertEquals(aLine.getValue(), aVintage);
        }
    }
    ...
    void testOrigins() {
        ...
        for (Entry<String, String> aLine : someInput.entrySet()) {
            ...
            assertEquals(aLine.getValue(), anOrigin);
        }
    }

    @Test
    void testGetAuctionDate() {
    ...
    void testIsRecordLine() {
        ...
        for (String aTestRecordLine : someRecordLines) {
            ...
            assertTrue(recordLine, aTestRecordLine + " isn't recognized as recordLine !");
        }
    }
    ...
    void testGetProducer() {
        ...
        assertNotNull(new WermuthPre2015ImportTask().getProducer("MO/DOC", aTestOriginContainingProducerLine));
    }

    @Test
    void testGetOrigin() {
        String aMODOCOrigin = "MO/DOC, Toscana, Cantina Constanti";
        assertEquals("MO/DOC", WermuthPre2015ImportTask.getOrigin(aMODOCOrigin));

        String aMOIGTOrigin = "MO/IGT, Toscana, Antinori";
        assertEquals("MO/IGT", WermuthPre2015ImportTask.getOrigin(aMOIGTOrigin));

        String aMoDOCGOrigin = "MO/DOCG, Piemont, Aldo Conterno";
        assertEquals("MO/DOCG", WermuthPre2015ImportTask.getOrigin(aMoDOCGOrigin));

        String aMOOrigin = "MO, Napa Valley, Mondavi/Rothschild";
        assertEquals("MO", WermuthPre2015ImportTask.getOrigin(aMOOrigin));

        String aACMCOrigin = "AC/MC, Margaux, 1er grand cru classe";
        assertEquals("AC/MC", WermuthPre2015ImportTask.getOrigin(aACMCOrigin));

        String aDOMOOrigin = "DO/MO, Priorat, Alvaro Palacio";
        assertEquals("DO/MO", WermuthPre2015ImportTask.getOrigin(aDOMOOrigin));

        String aACEAOrigin = "AC/EA, Rheingau, Weingut Mönchhoff";
        assertEquals("AC/EA", WermuthPre2015ImportTask.getOrigin(aACEAOrigin));

        String anACMOOrigin = "AC/MO, Champagne, Armand de Brignac (Cattier)";
        assertEquals("AC/MO", WermuthPre2015ImportTask.getOrigin(anACMOOrigin));
    }

    @Test
    void testGetNoOfBottles() {
        ...
        for (Entry<String, Integer> aTestEntry : linesAndAssertValues.entrySet()) {
            assertEquals(aTestEntry.getValue(), new WermuthRecordLineExtractor(aTestEntry.getKey()).getNoOfBottles());
        }
    }
    ...
    void testGetVintage() {
        ...
        for (Entry<String, Integer> aTestEntry : linesAndAssertValues.entrySet()) {
            assertEquals(new WermuthRecordLineExtractor(aTestEntry.getKey()).getVintage(), aTestEntry.getValue());
        }
    }
    ...
    void testGetUnit() {
        ...
        for (Entry<String, BigDecimal> aTestEntry : linesAndAssertValues.entrySet()) {
            assertTrue(aTestEntry.getValue().equals(wermuthImportTask.determineSize(aTestEntry.getKey())));
        }
    }

    @Test
    void testGetLotNumber() {
        ...
        for (Entry<String, String> aTestEntry : linesAndAssertValues.entrySet()) {
            assertEquals(aTestEntry.getValue(), new WermuthRecordLineExtractor(aTestEntry.getKey()).getLotNumber());
        }
    }

    @Test
    void testGetPriceMinimum() {
        Map<String, Integer> linesAndAssertValues = new HashMap<>();
        ...
        for (Entry<String, Integer> aTestEntry : linesAndAssertValues.entrySet()) {
            assertEquals(aTestEntry.getValue(), new WermuthRecordLineExtractor(aTestEntry.getKey()).getMinPrice());
        }
    }

    @Test
    void testGetPriceMaximum() {
        Map<String, Integer> linesAndAssertValues = new HashMap<>();
        ...
        for (Entry<String, Integer> aTestEntry : linesAndAssertValues.entrySet()) {
            assertEquals(aTestEntry.getValue(), new WermuthRecordLineExtractor(aTestEntry.getKey()).getMaxPrice());
        }
    }
