...
public class SteinfelsTests {
	...
	public void testGetAuctionDate() {
		...
		Assert.assertEquals(LocalDate.of(2002, 5, 4), aDate);
	}
	...
	public void testGetVintage()
	{
		...
		for (Entry<String, Integer> aLine : someRecordLines.entrySet()) {
			...
			Assert.assertEquals(aLine.getValue(), new NewRecordLineExtractor(aLine.getKey()).getVintage());
		}
	}
	...
	public void testGetPrice()
	{
		...
		for (Entry<String, Integer> aLine : someRecordLines.entrySet()) {
			...
			Assert.assertEquals(aLine.getValue(), new NewRecordLineExtractor(aLine.getKey()).getRealizedPrice());
		}
	}
	...
	public void testSize()
	{
		...
		for (Entry<String, BigDecimal> aLine : someRecordLines.entrySet()) {
			...
			Assert.assertEquals(aLine.getValue(), new SteinfelsImportTask().getUnit(aLine.getKey()).getDeciliters());
		}
	}
