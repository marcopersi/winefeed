function vinogui2(){
  ...
  $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('vinogui2');
      ...
      vinogui2 = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'vinogui2', base, softPermutationId);
      $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('vinogui2.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_vinogui2';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_0) {
        name_0 = name_0.replace('vinogui2::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  vinogui2.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  vinogui2.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('vinogui2'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?vinogui2';
    strongName = '';
  }
  $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie9'], '8B1BB3020244C2A8EE448AC44812AC45');
      unflattenKeylistIntoAnswers(['gecko1_8'], '8FD5D50DECADE5BB7C9FD581E9263F25');
      unflattenKeylistIntoAnswers(['ie8'], '9F21CD676E8EC5143D56474A728F8552');
      unflattenKeylistIntoAnswers(['ie10'], 'DEACC1EE770A81D84CC4394EF718B868');
      unflattenKeylistIntoAnswers(['safari'], 'E578483A41845ADCA5F0987437D27D9A');
  ...
  , 50);
  $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'vinogui2', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  if (!__gwt_scriptsLoaded['sc/skins/EnterpriseBlue/load_skin.js']) {
    __gwt_scriptsLoaded['sc/skins/EnterpriseBlue/load_skin.js'] = true;
    document.write('<script language="javascript" src="' + base + 'sc/skins/EnterpriseBlue/load_skin.js"><\/script>');
  }
  ...
  $doc_0.write('<script defer="defer">vinogui2.onInjectionDone(\'vinogui2\')<\/script>');
}
