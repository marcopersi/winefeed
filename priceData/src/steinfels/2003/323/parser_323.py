...
def main():
    """Test parser on 323.pdf"""
    parser = SteinfelsParser323()
    
    # Use absolute path
    pdf_file = "/Users/marcopersi/development/winefeed/priceData/import/steinfels/source/2003/323.pdf"

    if os.path.exists(pdf_file):
        print(f"Testing parser 323 on {pdf_file}...")
