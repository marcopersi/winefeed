...
def main():
    ...
    # Use absolute path
    pdf_file = "/Users/marcopersi/development/winefeed/priceData/import/steinfels/source/2003/324.pdf"

    if os.path.exists(pdf_file):
        print(f"Testing parser 324 on {pdf_file}...")
