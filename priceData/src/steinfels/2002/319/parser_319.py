...
class SteinfelsParser319:
    def __init__(self):
        ...
        self.region_mappings = {
            ...
            'Saint': 'Saint-Emilion', # Fix Moulis-en-Méd -> Moulis-en-Médoc
        }
...
def main():
    """Test parser on 319.pdf"""
    parser = SteinfelsParser319()
    
    # Use absolute path
    pdf_file = "/Users/marcopersi/development/winefeed/priceData/import/steinfels/source/2002/319.pdf"
    
    if os.path.exists(pdf_file):
        print(f"Testing parser 319 on {pdf_file}...")
